...
//make_args: TODO(optional) returns a list of arguments to also be added to the function.  Example: item rewards or a new character
...
var triggered_stories = {
	...
	Low_food_solo: {text: "After that meal food was getting to be a bit low.  If [Name] didn't find some more soon it would be a big problem.",
		chars:1},
	Very_low_food_solo: {text: "[Name] was trying to ration his food but [he] still had to eat something to keep [his] energy up.  Those last meager rations still left [him] hungry{hungry}.  [He] looked at his dismal assortment of remaining food.  [He] could make due with what was left for one more day",
		chars:1
	},
	No_food_solo:{text: "[Name] looked down at the empty food box.  [He] was having trouble thinking straight now.  [He] walked outside and picked some grass from the ground and put it into [his] mouth.  [He] chewed it slowly, grimacing at the bitter taste.  [He] made [him]self swallow it anyway.  Eating grass really only made [him] feel worse.  If [he] didn't find some real food soon [he] would be too weak to even look for any more food let alone defend himself.",
		chars:1
	},
	Starving_solo:{text:"[Name] had lost track of how long it had been since [he] had anything to eat{Starving}.  [Name] put his hands on [his] bed and attempted to push [him]self up and out but [his] arms gave way and [he] fell flat onto the ground.  [He] lay on the ground and closed [his] eyes as [his] stomach digested itself.  Lying there in pain, [his] only hope was that someone would come and rescue [him] from this hellish world.  After what seemed like an eternity [he] began to hear the sound of someone approaching.  [Name] forced his eyes open slightly and could make out a blurry figure standing over [him].  \"Food, Food please\" [He] croaked out.  The figure got down on its knees beside [him].  [He] felt something wet on [his] arm and looked to see only dirty matted hair.  A moment later [he] felt sharp stabbing pain from [his] arm.  It had taken a bite out of [him].  The pain shook [him] momentarily out of [his] stupor and [he] curled [his] fist into a ball and used all his strenght to force it hard into the zombie's head with a loud yell.  But by now [he] had no strength left in him; the zombie was completely unfazed.  It bit down again into [his] arm, sinking its teeth deep inside and scraping against his bone.  [He] howled in agony and squirmed as pain filled [his] mind.  Black saliva from the zombie had seeped into [his] veins and was working its way through [his] body.  Within moments [his] mind would be taken over.  [He] cursed [his] inability to find the food that [he] needed; in the end [he] had become the food.  The pain overwhelemed [his] mind and [he] blacked out.  Within a minute the zombie had stripped [his] arm down to the bone but it went no further from there.  [Name] was dead{Dead}.  The body that had once been [Name] opened its eyes.",chars:1}
